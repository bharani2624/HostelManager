...
const Dashboard = ({ isOpen }) => {
    ...
    useEffect(() => {
        const dbRef = ref(database, '/hostel');  // Fetch from the root to get all blocks
    ...
    return (
        <div className="container-dashboard flex h-screen">
            <div className={`Content flex-1 p-5 transition-all duration-300 ${isOpen ? 'ml-56' : 'ml-0'} bg-blue-20 relative`}>
                <h1 className="text-center font-bold text-lg mb-4">Sapphire</h1>
                    ...
                    <table className="table-auto border-collapse w-full text-left shadow-2xl rounded-3xl overflow-hidden">
                        <thead className="bg-white text-black">
                            <tr>
                                ...
                                <th className="border-b border-gray-400 px-4 py-2">RRoom</th>
